...
//		  $this->admin_member_dan = $this->sun_admin($lohb);
     ...
     //   var_dump(count($lohb));
        ...
        $where[]=array("branch"=>array('in',array(16,17)));
        $bayb=M("cash")->where(array("branch"=>array('in',array(16,17))))->sum("money");
        $baybs=M("cash")->where($where)->sum("money");
        $bayb=$bayb/10000;
        ...
        //宝安2部
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(18,19)));
        $baeb=M("cash")->where(array("branch"=>array('in',array(18,19))))->sum("money");
        $baebs=M("cash")->where($where)->sum("money");
        $baeb=$baeb/10000;
        ...
        $this->assign('ebsum',$baebs);
         ...
         //现金1部
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(30,29)));
        $xjyb=M("cash")->where(array("branch"=>array('in',array(30,29))))->sum("money");
        ...
        $this->assign('xjybsums',$xjybs);
         ...
         //现金2部
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(7,8)));
        $xjeb=M("cash")->where(array("branch"=>array('in',array(7,8))))->sum("money");
        ...
        $this->assign('xjebsums',$xjebs);
          ...
          //现金3部
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>array('in',array(25,9)));
        $xjsb=M("cash")->where(array("branch"=>array('in',array(25,9))))->sum("money");
        ...
        $this->assign('xjsbsums',$xjsbs);
          ...
          //现金4部
        $where=array("starttime"=>array(array('gt',strtotime(date('Y-m-01 0:00:01'))),array("elt",mktime(23,59,59,date('m'),date('t'),date('Y')))));
        $where[]=array("branch"=>33);
        $xj4b=M("cash")->where(array("branch"=>33))->sum("money");
